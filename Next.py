# -*- coding: utf-8 -*-
"""
Created on Wed Apr 15 18:34:48 2020
...
expiry_dates=[date(2017,9,28),date(2017,10,26),date(2017,11,30),date(2017,12,28),date(2018,1,25),date(2018,2,22),date(2018,3,28),date(2018,4,26),date(2018,5,31),date(2018,6,28),date(2018,7,26),date(2018,8,30),date(2018,9,27)]
...
for i in range(0,12):
    stock_fut=get_history(symbol="TVSAUTO",
                        start=start_dat[i],
                        end=end_dat[i],
                        futures=True,
...
df.to_csv(r'C:\Users\KUNAL V\Downloads\TVSMOTOR_Next.csv')